...
\section{Validacija} \label{Validacija}

Prije opisa postupka validacije potrebno je objasniti mAP vrijednost \engl{Mean Average Precision}, jer se često koristi prilikom utvrđivanja 
